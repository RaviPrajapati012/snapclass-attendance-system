...
def student_dashboard():
    ...
    with st.spinner('Loading your emnrolled subjects..'):
...
def student_screen():
    ...
    if show_registration:
         with st.container(border = True): 
             ...
             new_name = st.text_input("Enter your name", placeholder ='E.g. Nikhil Verma')
                 ...
                 if new_name:
                     with st.spinner('Creating profile..'):
                         ...
                         if encodings:
                            ...
                            st.error('Couldnt capture your facial features for regeistration')
                 else:
